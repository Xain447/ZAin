...
class AppText {
  ...
  static init() {
    ...
    b1 = baseStyle.copyWith(fontSize: AppDimensions.font(10), color: ColorManager.secondaryColor);
    b1b = b1!.copyWith(fontWeight: b, color: ColorManager.secondaryColor);

    b2 = baseStyle.copyWith(fontSize: AppDimensions.font(8));
    b2b = b2!.copyWith(fontWeight: b);

    l1 = baseStyle.copyWith(fontSize: AppDimensions.font(6), color: ColorManager.secondaryColor);
