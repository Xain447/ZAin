...
class ClipperLeftWidget extends StatelessWidget {
  final String title, company, date, location, url, website;
  const ClipperLeftWidget({Key? key, required this.title, required this.company,
        ...
        Directionality(
          ...
          child: Container(
            ...
            decoration: const BoxDecoration(
                border: Border(right: BorderSide(color: ColorManager.whiteColor))
            ),
            child: Column(
